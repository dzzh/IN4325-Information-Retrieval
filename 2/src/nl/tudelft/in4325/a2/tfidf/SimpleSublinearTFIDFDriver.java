...
public class SimpleSublinearTFIDFDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		createIndexJob.setJarByClass(SimpleSublinearTFIDFDriver.class);
		...
		createTFIDFjob.setJarByClass(SimpleSublinearTFIDFDriver.class);
		createTFIDFjob.setMapperClass(SimpleSublinearTFIDFMapper.class);
