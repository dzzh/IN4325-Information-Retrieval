...
After comparison of results we see that advanced mapper provides with less noise in results which is definitely better for processing. However, the better normalisation algorithms are, the more computing time they need.  
